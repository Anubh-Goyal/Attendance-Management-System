...
#   'messagingSenderId': "",
#   'appId': "",
    'apiKey': "AIzaSyBF7yS20EZzkNipZHk9KgxD5LNbNQObF8c",
    'authDomain': "bsafe-d5aa9.firebaseapp.com",
    'databaseURL': "https://bsafe-d5aa9.firebaseio.com",
    'projectId': "bsafe-d5aa9",
    'storageBucket': "bsafe-d5aa9.appspot.com",
    'messagingSenderId': "101188415110",
    'appId': "1:101188415110:web:74d9db4c4261915fbb2b07",
    'measurementId': "G-CJL553MB8T"
}
...
def student_signup():
    if request.method == 'GET':
        ...
        division_ref = db.collection('division').document(division)
        division_ref.set({
            'year': year,
            'sem': sem,
        }, merge=True)

        # Add student data to 'student' subcollection under 'division'
        student_ref = division_ref.collection('student').document(email)
        student_ref.set({
            'name': name,
            'roll_no': roll_no,
        })
